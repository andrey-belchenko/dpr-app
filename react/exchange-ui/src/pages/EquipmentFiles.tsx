...
import Grid, { GridRef } from "src/components/Grid";
import GridTest from "src/components/GridTest";
import { createArrayStore, downloadFile, getArray } from "src/data/apiClient";
const columns = [
  {
    // width:72,
    fixed: true,
